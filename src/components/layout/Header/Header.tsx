...
const Header = ({ children }: HeaderProps) => {
  return (
    <header className="md:sticky lg:top-0 lg:backdrop-blur">
      <input
        type="checkbox"
      ...
      >
        <div className="flex flex-col gap-6 lg:container lg:flex-row lg:w-full lg:justify-between lg:items-center lg:py-6">
          {children}
        </div>
      </div>
    </header>
